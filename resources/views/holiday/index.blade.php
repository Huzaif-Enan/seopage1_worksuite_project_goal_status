        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th>Long Form Fillup Date</th>
                    <th>Deliverable Signed Date</th> 
                    <th>Events</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$row->budget}}</td>
                     <td>{{$row->project_form}}</td>
                     <td>{{$row->project_sign}}</td>
                    <td>@foreach($row->events as $event_row)
                        {{$event_row->message}} <br>
                        <b>Notification Date:</b>{{$event_row->date}}
                        @endforeach
                    </td>
                </tr>
                @endforeach
