...
class HolidayController extends AccountBaseController
{
    ...
    public function index(HolidayDataTable $dataTable)
    {
        ...
        $project_status = DB::table('projects')->select('projects.pm_id', 'users.name as manager_name', 'projects.client_id', 'clients.name as client_name', 'projects.id', 'projects.project_name', 'projects.project_budget as budget','contract_signs.created_at as project_sign','deals.created_at as project_form', 'pm_projects.created_at as project_start')
